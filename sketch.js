...
var obstaclesGroup, diamondsImage,pathImage;
...
function preload(){
    girl_running = loadAnimation("girl1_standing,jpg","girl_running.jpg","girl_running2.png");
    girl_collided = loadAnimation("girl_fell.jpg");
    
    groundImage = loadImage("ground.png");
    
    cloudImage = loadImage("cloud.png");
    
    obstacle1 = loadImage("zombie1.png.jpg");
    obstacle2 = loadImage("zombie2.png.jpg");
    obstacle3 = loadImage("zombie3.png.jpg");
    obstacle4=loadImage("zombie4.png");
    obstacle5=loadImage("zombie5.png");
    obstacle5=loadImage("zombie6.png");

    restartImg = loadImage("restart.png.jpg");
